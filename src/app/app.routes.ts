...
export const routes: Routes = [
  ...
  {
    path: 'verify-email',
    loadComponent: () => import('./features/auth/pages/verify-email-page/verify-email-page').then((m) => m.VerifyEmailPage),
  },
  {
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        canActivate: [authGuard],
        loadComponent: () => import('./features/production/pages/credit-requests-page/credit-requests-page').then((m) => m.CreditRequestsPage),
      },
      {
